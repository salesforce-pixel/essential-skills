...
```sfdocs-code {"lang":"agentscript", "title": "Variable References in Output"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Action References in Instructions"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Combined References"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Conditional Variable References"}
reasoning:
  instructions: ->
