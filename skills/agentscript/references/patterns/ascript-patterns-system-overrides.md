...
```sfdocs-code {"lang":"agentscript", "title": "System Override to Resolve Conflict"}
system:
...
```sfdocs-code {"lang":"agentscript", "title": "Technical Support Override"}
subagent technical:
...
```sfdocs-code {"lang":"agentscript", "title": "Creative Mode Override"}
subagent creative:
