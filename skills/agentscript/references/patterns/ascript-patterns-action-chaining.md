...
```sfdocs-code {"lang":"agentscript", "title": "Sequential Actions"}
reasoning:
  instructions: ->
    # First action
...
```sfdocs-code {"lang":"agentscript", "title": "Chained Actions"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Action Then Transition"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Conditional Action Chain"}
reasoning:
  instructions: ->
    # First action
