...
```sfdocs-code {"lang":"agentscript", "title": "Transitions as LLM Reasoning Action"}
...
```sfdocs-code {"lang":"agentscript", "title": "Filtered Transitions"}
reasoning:
  actions:
...
```sfdocs-code {"lang":"agentscript", "title": "Reference Transitions"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Transition After Action"}
reasoning:
  instructions: ->
