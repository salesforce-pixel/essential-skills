...
```sfdocs-code {"lang":"agentscript", "title": "Example Uses of Variables"}
variables:
...
```sfdocs-code {"lang":"agentscript", "title": "Initialize Variables"}
variables:
...
```sfdocs-code {"lang":"agentscript", "title": "Descriptive Variables"}
variables:
...
```sfdocs-code {"lang":"agentscript", "title": "Store Action Outputs"}
reasoning:
  instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Example: Share Information Between Subagents"}
reasoning:
    instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Example: Let the LLM Set Variable Values"}
reasoning:
