...
```sfdocs-code {"lang":"agentscript", "title": "Providing Additional Instructions to the LLM (optional)"}
...
```sfdocs-code {"lang":"agentscript", "title": "Action Chaining"}
...
```sfdocs-code {"lang":"agentscript", "title": "Actions and Tools"}
subagent my_topic:
...
```sfdocs-code {"lang":"agentscript", "title": "Action Inputs"}
inputs:
    email: string
        label: "Email Address"
...
```sfdocs-code {"lang":"agentscript", "title": "Flow Target"}
flow://AssignSalesRep
```

```sfdocs-code {"lang":"agentscript", "title": "Prompt Target"}
...
```sfdocs-code {"lang":"agentscript", "title": "Action Outputs"}
outputs:
...
```sfdocs-code {"lang":"agentscript", "title": "Run Actions in Logic Instruction"}
reasoning:
    instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Specify Tools in Reasoning Actions"}
reasoning:
    actions:
...
```sfdocs-code {"lang":"agentscript", "title": "Reference Actions in Prompt Instruction"}
reasoning:
    instructions: ->
