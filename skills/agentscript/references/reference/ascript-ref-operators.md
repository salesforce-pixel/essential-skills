...
| Grouping   | `( )`    | Parentheses            | `(@variables.x or @variables.y) and @variables.z` See [Agent Script Reference: Conditional Expressions](./ascript-ref-expressions.md) for examples. |
