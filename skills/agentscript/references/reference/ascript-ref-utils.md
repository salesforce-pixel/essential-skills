...
```sfdocs-code {"lang":"agentscript", "title": "Utils.Transition to: Subagent Routing"}
# during reasoning
...
```sfdocs-code {"lang":"agentscript", "title": "Utils.Transition to: Conditional Approval Workflow"}
...
```sfdocs-code {"lang":"agentscript", "title": "Utils.Transition to: Flow of Control"}
...
```sfdocs-code {"lang":"agentscript", "title": "Utils.setVariables: Get First Name"}
reasoning:
    actions:
...
```sfdocs-code {"lang":"agentscript", "title": "Utils.escalate: Escalate to Human Rep"}
...
```sfdocs-code {"lang":"agentscript", "title": "Utils.end_session: The LLM Chooses When End the Conversation"}
reasoning:
    instructions: ->
...
```sfdocs-code {"lang":"agentscript", "title": "Agent Router Transitions to EndSession"}
variables:
